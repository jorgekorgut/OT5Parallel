...
__global__ void calculatePi(double *pi, double step, int num_steps, int threadSize);
...
__global__ void calculatePi(double *sum, double step, int num_steps, int threadSize)
{
